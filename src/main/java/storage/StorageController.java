...
public class StorageController implements IStorageController {
    ...
    public Map<String, ArrayList<String>> readUserFile(){
        ...
        readCSV("src/main/user_data/UserList.csv").stream().skip(1)
    ...
    public void writeUserFile(Map<String, ArrayList<String>> USERS){ //Replace userList.csv
        try(BufferedWriter bw = new BufferedWriter(new FileWriter("src/main/user_data/UserList.csv"))){
    ...
    public Map<String, Project> readProjectFile(){
        ...
        readCSV("src/main/user_data/ProjectList.csv").stream().skip(1)
    ...
    public void writeProjectFile(Map<String, Project> PROJECT){ //Replace userList.csv
        try(BufferedWriter bw = new BufferedWriter(new FileWriter("src/main/user_data/ProjectList.csv"))){
    ...
    public Map<String, Enquiry> readEnquiryFile(){
        ...
        readCSV("src/main/user_data/Enquiry.csv").stream().skip(1)
    ...
    public void writeEnquiryFile(Map<String, Enquiry> ENQUIRY){ //WRITES using ENQUIRY in Storage
        try(BufferedWriter bw = new BufferedWriter(new FileWriter("src/main/user_data/Enquiry.csv"))){
    ...
    public Map<String, BTOApplication> readBTOApplicationFile(){
        ...
        readCSV("src/main/user_data/BTOApplication.csv").stream().skip(1)
    ...
    public void writeBTOApplicationFile(Map<String, BTOApplication> BTOAPPLICATIONS){
        try(BufferedWriter bw = new BufferedWriter(new FileWriter("src/main/user_data/BTOApplication.csv"))){
