...
public class HDBOfficer extends Applicant {
    ...
    private String projectsAllocated; //find out Project allocated and Registration from ProjectTeam
...
public void checkProjectsAllocated(Storage storage) {
    ...
    public String getProjectsAllocated() { return this.projectsAllocated; }
    public void addProjectsAllocated(String projectName){
        this.projectsAllocated+="."+ projectName;
    }
